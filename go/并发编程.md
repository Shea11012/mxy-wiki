...
![image-20200514020140398](image-20200514020140398.png)
...
- 非阻塞 I/O：当一个进程把一个文件描述符设置成非阻塞时，执行 read 和 write 等 I/O 操作就会立即返回。
  ...
  ![image-20200514020452963](image-20200514020452963.png)
...
![image-20200514141939275](image-20200514141939275.png)
